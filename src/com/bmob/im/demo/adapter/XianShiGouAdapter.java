			...
			if (imagelist != null && !imagelist.isEmpty()) {
				...
				for (i = 0; i < imagelist.size(); i++) {
					...
					if (imagelist.get(i).get(Constant.JIFEN_POSITION)
						...
						biaoti.setText(imagelist.get(i)
						...
						ImageLoader.getInstance().displayImage(
								...
								ImageLoadOptions.getOptions());
						biaoti4.setText(imagelist.get(i).get(
								Constant.JIFEN_NAME));
						...
						ImageLoader.getInstance().displayImage(
								...
								ImageLoadOptions.getOptions());
						biaoti3.setText(imagelist.get(i).get(
								Constant.JIFEN_NAME));
						...
						ImageLoader.getInstance().displayImage(
								...
								ImageLoadOptions.getOptions());
						biaoti2.setText(imagelist.get(i).get(
								Constant.JIFEN_NAME));
						...
						ImageLoader.getInstance().displayImage(
								...
								ImageLoadOptions.getOptions());
						biaoti1.setText(imagelist.get(i).get(
								Constant.JIFEN_NAME));
