...
public class XianShiGouAdapter extends BaseAdapter {
	...
	public View getView(int position, View v, ViewGroup parent) {
		if (position == 0) {
			...
			biaoti.setText(list.get(position - 1).get(Constant.XIANSHI_BIAOTI));
			fbiaoti.setText(list.get(position - 1)
					.get(Constant.XIANSHI_FBIAOTI));
			price.setText(list.get(position - 1).get(Constant.XIANSHI_PRICE));
